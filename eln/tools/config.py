"""Central configuration for agent-eln ELN tools.
...
Environment variables (all optional):
  ...
  AGENT_ELN_WIKI_DIR          -- wiki directory name at repo root    (default: "wiki")
  AGENT_ELN_ELN_DIR           -- eln directory name at repo root     (default: "eln")
"""
import os
