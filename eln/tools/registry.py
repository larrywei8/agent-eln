...
Per-field notes:
  ...
  is_resource   : whether this is a reusable resource (goes under resources/, appears in the resources.csv grouping).
...
SCHEMA_VERSION = "4.0"  # Phase 4: 26 types (MOU→MUS, PROT→SOP; added CHM/RCP/STR/KIT/PER)
...
_R = "resources"
TYPES = {
 # ---------------- Resource types (container=dir, under resources/) ----------------
 ...
 "protocol":  {"prefix":"SOP","id_style":"seq4","folder":"protocols","container":"file",
               "template":"protocol","label":"SOP (protocol)","is_resource":False,
               "required":["id","type","name","created","created_by"],
               "who_field":"created_by","status_field":None,"allowed_status":[],
               "table":"protocols","table_cols":["version","category","est_time","tags"]},
 "pipeline":  {"prefix":"PIPE","id_style":"seq4","folder":"pipelines","container":"file",
 ...
 "idea":      {"prefix":"IDEA","id_style":"seq4","folder":"ideas","container":"file",
 ...
 "project":   {"prefix":"PRJ","id_style":"seq4","folder":"projects","container":"dir",
 ...
 "experiment":{"prefix":"EXP","id_style":"date-nn","folder":"experiments","container":"file",
 ...
 "daily-summary":{"prefix":"DAILY","id_style":"date","folder":"experiments","container":"file",
 ...
 "meeting":   {"prefix":"MTG","id_style":"date","folder":"meetings","container":"file",
